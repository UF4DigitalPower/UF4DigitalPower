...
/*使用标准的“memcpy”和“memset”代替LVGL自身的功能。（可能更快也可能不快）.*/
 ...
 *
 * - LV_LAYER_SIMPLE_BUF_SIZE: [bytes] 最优的目标缓冲区大小。LVGL会尝试分配
 * - LV_LAYER_SIMPLE_FALLBACK_BUF_SIZE: [bytes]  如果无法分配“LV_LAYER_SIMPLE_BUF_SIZE”，就会用.
 *
...
#define LV_ATTRIBUTE_LARGE_RAM_ARRAY __attribute__((section(".ram_d2")))
...
#define LV_USE_FONT_SUBPX 1
    ...
    /*设置显示的像素顺序。RGB通道的物理顺序。对于“普通”字体来说，这没什么区别。*/
