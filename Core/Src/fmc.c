...
/* Board note: PROGRAMMED write burst can cause display black screen. */
#define SDRAM_MODEREG_WRITEBURST_SELECTED SDRAM_MODEREG_WRITEBURST_MODE_SINGLE
...
void SDRAM_Initialization_Sequence(SDRAM_HandleTypeDef *hsdram, FMC_SDRAM_CommandTypeDef *Command) {
  ...
  tmpmrd = (uint32_t)SDRAM_MODEREG_BURST_LENGTH_2               |//设置突发长度：2（可以是1/2/4/8）
              ...
              SDRAM_MODEREG_WRITEBURST_SELECTED;  //当前板级请保持 SINGLE，PROGRAMMED 会黑屏
