...
.word	_ebss
/* start address for the initialization values of the .RamFunc section */
.word	_si_ramfunc
/* start address for the .RamFunc section */
.word	_s_ramfunc
/* end address for the .RamFunc section */
.word	_e_ramfunc
...
/* Copy ram functions from flash to SRAM */
  ldr r0, =_s_ramfunc
  ldr r1, =_e_ramfunc
  ldr r2, =_si_ramfunc
  movs r3, #0
